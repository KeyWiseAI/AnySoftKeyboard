...
public final class BiADatabaseManager implements BiADBInterface.TouchDataInterface,
                                                 BiADBInterface.KeyDataInterface,
                                                 BiADBInterface.SessionDataInterface,
                                                 BiADBInterface.AccelerometerData,
                                                 BiADBInterface.DeviceData {
    ...
    private BiADatabaseManager(Context appContext) {
        ...
        mDatabaseInstance = Room.databaseBuilder( appContext,
                                                  BiAffect_Database.class,
     ...
     */
    public static List<TouchTypeData> getTouchTypeData( long time ) {
        return mDatabaseInstance.mTouch_dao().getTouchTypeData( time );
    }

    //exposed Api for touch data
    @Override
    public void insertTouchData( long eventDownTime,
                                 long eventTime,
                                 String eventAction,
                                 float pressure,
                                 float x_cord,
    ...
    @Override
    public void insertKeyData( long keyDownTime,
                               String keyCode,
                               float centre_X,
                               float centre_Y,
                               float width,
